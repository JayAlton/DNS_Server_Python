...
def main():
    ...
    while True:
        try:
            ...
            # QUESTIONS
            q_domain = (calculate_domain_long(12, buf) + b"\x00") # Name label sequence \xzz for size and then content
            ...
            # ANSWERS
            a_name = (calculate_domain_long(12, buf) + b"\x00") # Name Label Sequence
            ...
            response = header + questions + answer
